...
const [EmploymentField,setEmploymentField] = useState(null)
  const [password,setPassword] = useState(null)
   ...
   const {createUser,user,createCompany,createIndividualUser,paymentProcessor} = UseAuth();
     ...
     const storageRef = ref(storage, "governmentI/");
      ...
      createUserWithEmailAndPassword(auth, Companyemail, companyPassword).then((credentials=>{
        ...
        //   let authKey = "AUTH_KEY";
            ...
            setDoc(doc(firestore, "PremiumCompanyEmployer",credentials.user.uid), {
              active:false,
              paid:false,
...
export default PremiumEmployerCompany;
