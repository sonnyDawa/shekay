...
const CheckoutpageEmployer = () => {
    ...
    const handleProcess = (e) => {
        ...
        if (paymentProcessor == "commercial bank of ethiopia"){
            updateDoc(doc(db, "PremiumIndividualEmployer", users.uid), {
                            ...
                            <div class="flex flex-col space-y-4">
                                <div class="flex space-x-4">
                                    ...
                                    <div>
                                        ...
                                        <span class="text-red-600">Price</span> 199.99 Birr
                                    </div>
                                    <div>
...
export default CheckoutpageEmployer;
