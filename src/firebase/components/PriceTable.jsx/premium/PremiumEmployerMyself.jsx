...
import { getFirestore ,collection,setDoc,doc,serverTimestamp,addDoc} from 'firebase/firestore';
...
const PremiumEmployerMyself = () => {
   ...
   const {createUser,user,createIndividualUser} = UseAuth();
   const plan = "premium"
    ...
    createUserWithEmailAndPassword(auth,email,password).then(credentials=>{
        ...
        //   let authKey = "AUTH_KEY";
                   ...
                   getDownloadURL(uploadImage.snapshot.ref).then((downloadURL) => {
                    ...
                    setDoc(doc(firestore, "PremiumIndividualEmployer",credentials.user.uid), {
           ...
           //  FieldOfStudy:jobStudy,
            ...
            setDoc(doc(firestore, "TotalUsers",credentials.user.uid), {
                  timestamp: serverTimestamp(),
                  paid:false,
                  active:false,
                  firstName:firstName,
                ...
                }).then(navigate("/premium/employer/checkout")).catch(e=>(console.log(e.message))) 
...
<form onSubmit={handleSubmit} id="signUpContainerpage" className='signUpContainerpage' >
...
export default PremiumEmployerMyself;
