...
const  ProfessionalEmployerCompany = () => {
...
const [EmploymentField,setEmploymentField] = useState(null)
 ...
 const submit = (e)=>{
    const storageRef = ref(storage, "governmentI/");
     ...
     createUserWithEmailAndPassword(auth, Companyemail, companyPassword).then((credentials=>{
       ...
       //   let authKey = "AUTH_KEY";
           ...
           setDoc(doc(firestore, "ProfessionalCompanyEmployer",credentials.user.uid), {
      ...
      }).then(addDoc(collection(db,"TotalUsers"),{
       Companystatus:Companystatus,
       Companyemail: Companyemail,
       CompanyName: CompanyName,
...
export default ProfessionalEmployerCompany;
