...
const ProfessionalEmployerMyself = () => {
    ...
    createUserWithEmailAndPassword(auth,email,password).then(credentials=>{
        ...
        //   let authKey = "AUTH_KEY";
                   ...
                   getDownloadURL(uploadImage.snapshot.ref).then((downloadURL) => {
                    ...
                    setDoc(doc(firestore, "ProfessionalIndividualEmployer",credentials.user.uid), {
           ...
           //  FieldOfStudy:jobStudy,
            ...
            addDoc(collection(db,"TotalUsers"), {
                  timestamp: serverTimestamp(),
                  firstName:firstName,
                  lastname:lastname,
                  email:email,
                ...
                }).then(navigate("/professional/checkout")).catch(e=>(console.log(e.message))) 
...
export default ProfessionalEmployerMyself;
