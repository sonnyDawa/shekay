...
export const time = `${current.getHours()}:${current.getMinutes()}:${current.getSeconds()}`;
...
const Accountemployer = () => {
 ...
 if (activity.length == 0){
    ...
    //              users.push({...doc.data()})
    //              console.log(doc.data().uniqueKey)
    //              setActivity(users)
...
function cancelHandle(id){
    // setselectedRecent(id)
    main.style.width=("115%")
...
function handlecross(){
 ...
 deleteDoc(doc(deleteDocument, selectedRecent)).then(
    main.style.width=(0),
    main.style.zIndex=(-100)
...
//           const activity = []
//           activity.push({...snapshot.data(),id:snapshot.id})
//           setDoc(activity)
...
//       }, []);
    ...
    >
            <div class="relative p-6">
                ...
                <h1 class="text-3xl font-bold">Delete Job</h1>
                <p class="text-sm text-gray-500">Are you sure you want to permanently delete this Job?</p>
                
                <div class="flex flex-row mt-6 space-x-2 justify-evenly">
                    <a href="#" onClick={deleteHandler} class="w-full py-3 text-sm font-medium text-center text-white transition duration-150 ease-linear bg-red-600 border border-red-600 rounded-lg hover:bg-red-500">Delete</a>
                    <a href="#"  onClick={handlecross}class="w-full py-3 text-sm text-center text-gray-500 transition duration-150 ease-linear bg-white border border-gray-200 rounded-lg hover:bg-gray-100">Cancel</a>
                </div>
            </div>
    </div>
</div>
...
<div className="px-6 pt-6 2xl:container">
    ...
    <div className="md:col-span-2 lg:col-span-1" >
            <div className="lg:h-full py-8 px-6 text-gray-600 rounded-xl  bg-white">
                <div class="bg-pink dark:bg-gray-800 shadow-lg rounded-md flex items-center justify-between p-3 border-b-4  dark:border-gray-600 text-white font-medium group">
        ...
        <div className="md:col-span-2 lg:col-span-1" >
            ...
            <div class="text-right">
              <p class="text-2xl">{activity.length}</p>
              <p>Jobs You Posted</p>
            </div>
          </div>  
    ...
    {/* <div class="lg:px-24 lg:py-24 md:py-30 md:px-44 px-4 py-24 items-center flex justify-center flex-col-reverse lg:flex-row md:gap-28 gap-106">
        ...
        <div class="bg-white shadow-md rounded my-6">
            <table class="min-w-max w-full table-auto">
                <thead>
                    <tr class="height bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
...
return(
    ...
    <td class="py-3 px-6 text-center">
        <div class="flex item-center justify-center">
            ...
            <div class="w-4 mr-2  transform hover:text-purple-500 hover:scale-110" onClick={()=>cancelHandle(id)}>
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    {/* <tr class="height border-b border-gray-200 bg-gray-50 hover:bg-gray-100  " >
                        <td class="py-3 px-6 text-left">
                            <div class="flex items-center">
                                <div class="mr-2">
