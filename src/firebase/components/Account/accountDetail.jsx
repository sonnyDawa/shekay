...
const AccountDetail = () => {
    const {firstName,lastname,email,phoneNumber,photo,birthDate,region,jobTitle} = UseAuth()
    const reset = ()=>{
  ...
  .catch((error) => {
    ...
    // ..
                  ...
                  function handlePop(){
                    const pop = document.getElementById("popup_main-profile")
...
<div class="h-full bg-gray-200 p-8">
        <div class="bg-white rounded-lg shadow-xl pb-8">
            <div x-data="{ openSettings: false }" class="absolute right-12 mt-4 rounded">
                <button onClick={handlePop} class="border border-gray-400 p-2 rounded text-gray-300 hover:text-gray-300 bg-gray-100 bg-opacity-10 hover:bg-opacity-20" title="Settings">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="currentColor" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="3" d="M12 5v.01M12 12v.01M12 19v.01M12 6a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2zm0 7a1 1 0 110-2 1 1 0 010 2z"></path>
                    </svg>
                </button>
                <div id='popup_main-profile' class=" bg-white absolute right-0 w-40 py-2 mt-1 border border-gray-200 shadow-2xl" style={{display: "none"}}>
                    ...
                    <div class="py-2">
                        <button class="w-full flex items-center py-1.5 px-6 space-x-2 hover:bg-gray-200">
                            ...
                            <span class="text-sm text-gray-700">Log out</span>
                        </button>
                    </div>
                </div>
            </div>
            <div class="w-full h-[250px]">
              {/* <img className='p-fit w-full h-full rounded-tl-lg rounded-tr-lg ' src="https://firebasestorage.googleapis.com/v0/b/logo-2-c33ae.appspot.com/o/undraw_Profile_re_4a55.png?alt=media&token=9240d3d1-1077-47fa-9525-62ab897c2a8a" alt="" /> */}
              <div class="w-full h-full welcomeCenter  bg-blue-700  focus:ring-4 focus:outline-none   w-full sm:w-auto   dark:bg-blue-600  ">
                <h1 class='text-gray-700 text-4xl font-black welcome capitailize'>Welcome {firstName} {lastname} </h1>
              </div>
            </div>
            <div class="flex flex-col items-center -mt-20">
                <img src={photo} class="square w-40 border-4 border-white rounded-full"/>
                <div class="flex items-center space-x-2 mt-2">
                    <p class="text-2xl">{firstName} {lastname}</p>
                ...
                <div class="flex-1 bg-white rounded-lg shadow-xl p-8">
                    ...
                    <ul class="mt-2 text-gray-700">
                        ...
                        <li class="flex border-b py-2">
                            <span class="font-bold w-24">Birth day:</span>
                            <span class="text-gray-700">{birthDate}</span>
                        </li>
                        <li class="flex border-b py-2">
                            <span class="font-bold w-24">Job title: </span>
