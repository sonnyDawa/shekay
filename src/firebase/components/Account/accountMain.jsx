...
import { getFirestore,doc,setDoc, addDoc, collection, onSnapshot } from 'firebase/firestore';
...
const AccountMain = () => {
    ...
    const activityRef = collection(db, "Authenticationn")
    ...
    useEffect(() => {
        (async()=>{
         onSnapshot(collection(activityRef, users.uid, 'UserDetails'),(snapshot)=>{
             let recent = []
    ...
    <div>
     ...
     <div className="mt-8 text-center">
            ...
            <h5 className="hidden mt-4 text-xl font-semibold text-gray-600 lg:block capitalize">{firstName}  {lastname}</h5>
        ...
        <ul className="space-y-2 tracking-wide mt-8">
          ...
          <a href="#" className="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group">
                    ...
                    <span className="group-hover:text-gray-700">Find jobs</span>
                </a></Link>
            </li>
            <li>
                <a href="#" className="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group">
                    ...
                    <span className="group-hover:text-gray-700">Available Employers</span>
                </a>
            </li>
            <li>
                <a href="#" className="px-4 py-3 flex items-center space-x-4 rounded-md text-gray-600 group">
